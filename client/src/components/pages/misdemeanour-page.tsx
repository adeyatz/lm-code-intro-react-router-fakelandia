...
const MISDEMEANOUR_URL = `http://localhost:8080/api/misdemeanours/5`;
...
const MisdemeanourPage: React.FC = () => {
  ...
  const { misdemeanours, status } = useFetchMisdemeanours(MISDEMEANOUR_URL);

  return (
    <>
      {status === "Error" && <p>Error Fetching Misdemeanours</p>}
